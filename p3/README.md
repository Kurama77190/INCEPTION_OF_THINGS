...
**Tu dois créer un repo GitHub avec tes manifests Kubernetes** :
...
**Les fichiers sont déjà prêts dans `p3/github-manifests/` !**
...
### 5. Tester le changement de version (v1 → v2)

**Édite `deployment.yaml` dans ton repo GitHub :**
```yaml
# Ligne à modifier
...
**ArgoCD détecte automatiquement (sous ~3 min) et redéploie !**
...
# Vérifier que le pod utilise v2
